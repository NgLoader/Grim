...
public record PostgresqlViolationDatabase(HikariDataSource dataSource) implements ViolationDatabase {

    private static final DatabaseDialect DIALECT = new PostgresqlDialect();
